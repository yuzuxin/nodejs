...
describe("task111",function(){
    ...
    it("return the song when the number equal 2",function(){
        let number = 2;
        let result = main(number);
        let str = "2 bottles of beer on the wall, 2 bottles of beer.\n" +
         "Take one down and pass it around, 1 bottle of beer on the wall.\n";
        expect(result).toEqual(str);
    })
    it("return the song when the number equal 1",function(){
        let number = 1;
        let result = main(number);
    ...
    it("return the song when the number less than 0",function(){
        let number = 0;
        let result = main(number);
